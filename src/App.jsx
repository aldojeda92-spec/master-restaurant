...
function VistaAdmin({ inventario, restauranteConfig, paywallBloqueado }) {
  ...
  const facturarMesaCaja = async (mesaId, alerta) => {
    ...
    if (alerta && alerta.tipo_division === 'separadas') {
      ...
      mensajeConf = `¿Confirmar cobro individual de ${divisa} ${alerta.total_final.toLocaleString()} a ${alerta.solicitante}? (El resto de la mesa seguirá activa)`;
    } else {
      ...
      mensajeConf = `¿Confirmar cobro TOTAL de la Mesa ${mesaId}?`;
    }
